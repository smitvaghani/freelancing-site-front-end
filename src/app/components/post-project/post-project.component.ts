...
export class PostProjectComponent implements OnInit {
  PostProjectForm!: UntypedFormGroup;
  FileToUpload!: any;
  fileName: string = "";
  ...
  ngOnInit(): void {
    ...
    this.PostProjectForm = new UntypedFormGroup({
      projectNameControl: new UntypedFormControl("", [Validators.required, Validators.minLength(10)]),
      descriptionControl: new UntypedFormControl("", [Validators.required, Validators.minLength(30)]),
      fileControl: new UntypedFormControl(),
      categoryControl: new UntypedFormControl("", Validators.required),
      MaxBudgetControl: new UntypedFormControl("", Validators.required),
      MinBudgetControl: new UntypedFormControl("", [Validators.required, Validators.min(600)]),
      DurationControl: new UntypedFormControl("", Validators.required)
